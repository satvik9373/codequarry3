    ...
    (u = t && t.fn && t.fn.select2 && t.fn.select2.amd ? t.fn.select2.amd : u) && u.requirejs || (u ? e = u : u = {}, f = {}, g = {}, m = {}, y = {}, n = Object.prototype.hasOwnProperty, i = [].slice, v = /\.js$/, p = function(e, t) {
            ...
            return e.Extend(i, e.Observable), i.prototype.render = function() {
                ...
                var t = this.options.get("escapeMarkup"),
                    n = (this.clear(), this.hideLoading(), u('<li role="treeitem" aria-live="assertive" class="select2-results__option"></li>')),
                ...
                for (t in e.disabled && (delete i["aria-selected"], i["aria-disabled"] = "true"), null == e.id && delete i["aria-selected"], null != e._resultId && (n.id = e._resultId), e.title && (n.title = e.title), e.children && (i.role = "group", i["aria-label"] = e.text, delete i["aria-selected"]), i) n.setAttribute(t, i[t]);
                if (e.children) {
                    for (var o = u(n), s = document.createElement("strong"), r = (s.className = "select2-results__group", u(s), this.template(e, s), []), a = 0; a < e.children.length; a++) {
                        var l = e.children[a],
                            l = this.option(l);
                        r.push(l)
                    }
                    ...
                    c.append(r), o.append(s), o.append(c)
